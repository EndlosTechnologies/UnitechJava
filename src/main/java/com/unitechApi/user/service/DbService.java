                ...
                while (cellIterator.hasNext()) {
                    ...
                    switch (columnIndex) {
                        ...
                        case 8:
                            ...
                            break;
                        case 9:
                            String created = fmt.formatCellValue(nextCell);
                            log.info("date is ={}", created);
                            statement.setDate(10, Date.valueOf(created));
                            break;
                        case 10:
                        ...
                        case 11:
                            ...
                            log.info("product Name outer Loop ->{}", p_id);
                            log.info("product Name  getAll ->{}", productCategory);
