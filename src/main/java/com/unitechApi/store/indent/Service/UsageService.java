...
public class UsageService {
    ...
    public List<UsageItem> findByBloowDataAndDeptName(String deptname, Date start, Date end,long id)
    {
        return usageRepository.findByDeptNameAndCreatedBetweenAndBloowusageId(deptname ,start,end,id);
    }
