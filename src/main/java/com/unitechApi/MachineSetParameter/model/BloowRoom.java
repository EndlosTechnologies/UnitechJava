...
public class BloowRoom {
    ...
    @JoinColumn(foreignKey = @ForeignKey(name = "b_m_id"),
    ...
    public AddBloowroom getAddBloowroom() {
        return addBloowroom;
    }

    public void setAddBloowroom(AddBloowroom addBloowroom) {
        this.addBloowroom = addBloowroom;
    }
    ...
    public void UpdateidBlowRoom(AddBloowroom addBloowroom) {
        this.addBloowroom = addBloowroom;
    }
