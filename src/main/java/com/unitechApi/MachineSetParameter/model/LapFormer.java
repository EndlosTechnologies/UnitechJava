...
@Entity
@Table(name = "lapformermachine", schema = "machinereading")
public class LapFormer {
    @Id
    ...
    @Column(name = "productiononratekgcard8perhour", nullable = false, updatable = false)
    private float productiononratekgcard8perhour;
    ...
    @JoinColumn(foreignKey = @ForeignKey(name = "l_m_id"), name = "l_m_id", referencedColumnName = "m_id")
    @JsonIgnoreProperties("lapFormersreading")
    private AddLapFormer addLapFormer;

    public AddLapFormer getAddLapFormer() {
        return addLapFormer;
    }

    public void setAddLapFormer(AddLapFormer addLapFormer) {
        this.addLapFormer = addLapFormer;
    }
    ...
    public float getProductiononratekgcard8perhour() {
        return productiononratekgcard8perhour;
    }

    public void setProductiononratekgcard8perhour(float productiononratekgcard8perhour) {
        this.productiononratekgcard8perhour = productiononratekgcard8perhour;
    }
    ...
    public void updateid(AddLapFormer addLapFormer) {
        this.addLapFormer=addLapFormer;
    }
}
