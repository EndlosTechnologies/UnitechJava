...
@Entity
@Table(name = "finisher_machine", schema = "machinereading")
public class FinisherperKg {
    @Id
    ...
    @JoinColumn(foreignKey = @ForeignKey(name = "f_m_id"), name = "f_m_id", referencedColumnName = "m_id")
    @JsonIgnoreProperties({"finisherperKgReading","finisherperhankMachineReading"})
    private AddFinisherMachine finisherMachine;

    public AddFinisherMachine getFinisherMachine() {
        return finisherMachine;
    }

    public void setFinisherMachine(AddFinisherMachine finisherMachine) {
        this.finisherMachine = finisherMachine;
    }
    ...
    public void idupdate(AddFinisherMachine addFinisherMachine) {
        this.finisherMachine = addFinisherMachine;
    }
}
