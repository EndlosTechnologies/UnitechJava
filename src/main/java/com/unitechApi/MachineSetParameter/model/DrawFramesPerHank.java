...
@Entity
@Table(name = "drawframesperhank_machine", schema = "machinereading")
@JsonIgnoreProperties(ignoreUnknown = true)
public class DrawFramesPerHank  {
    ...
    @JoinColumn(foreignKey = @ForeignKey(name = "dh_m_id"), name = "dh_m_id", referencedColumnName = "m_id")
    @JsonIgnoreProperties({"drawFramesPerHanks","drawframesperkgReading"})
    private AddDrawFramesMachine drawFramesPerHanks;



    /*
    *CONSTANT * deliveryspeed * machineefficency / 100;
    * productiononratekgdfper8hour / 8 * 6;
    * productiononratekgdfper8hour * 3;
    * */
    ...
    public AddDrawFramesMachine getDrawFramesPerHanks() {
        return drawFramesPerHanks;
    }

    public void setDrawFramesPerHanks(AddDrawFramesMachine drawFramesPerHanks) {
        this.drawFramesPerHanks = drawFramesPerHanks;
    }

    public void idupdatedrawframes(AddDrawFramesMachine addDrawFramesMachine) {
        this.drawFramesPerHanks=addDrawFramesMachine;
    }
    ...
    public boolean equals(Object o) {
        ...
        DrawFramesPerHank that = (DrawFramesPerHank) o;
        return machineId != null && Objects.equals(machineId, that.machineId);
    }
