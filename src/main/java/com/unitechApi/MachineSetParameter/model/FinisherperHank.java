...
@Entity
@Table(name = "finisherhank_machine", schema = "machinereading")
public class FinisherperHank {
    @Id
    ...
    @JoinColumn(foreignKey = @ForeignKey(name = "fh_m_id"), name = "fh_m_id", referencedColumnName = "m_id")
    @JsonIgnoreProperties({"finisherperhankMachineReading","finisherperKgReading"})
    private AddFinisherMachine finisherhankMachine;
    ...
    public AddFinisherMachine getFinisherhankMachine() {
        return finisherhankMachine;
    }

    public void setFinisherhankMachine(AddFinisherMachine finisherhankMachine) {
        this.finisherhankMachine = finisherhankMachine;
    }
    ...
    public void updateid(AddFinisherMachine addFinisherMachine) {
    this.finisherhankMachine=addFinisherMachine;
    }
}
