...
public class CardingExcelService {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<Carding> ListUser;

    public CardingExcelService(List<Carding> listData){
    ...
    private void writeDataLine() {
       ...
       // styleHeader.set
        createCell(rowHeader2,1,"Carding ",styleHeader);
        ...
        style.setAlignment(HorizontalAlignment.CENTER);
        style.setFont(font);
        for (Carding carding :ListUser){
            Row row=sheet.createRow(rowcount++);
            int countRow=1;
            createCell(row,countRow++,carding.getCardingMachine().getName(),style);
            createCell(row,countRow++,carding.getDeliveryspeed(),style);
            createCell(row,countRow++,carding.getSilverhank(),style);
            createCell(row,countRow++,carding.getMachineefficency(),style);
            createCell(row,countRow++,carding.getProductiononratekgcardperhour(),style);
            createCell(row,countRow++,carding.getMachineefficencykgcardpershift(),style);
            createCell(row,countRow++,carding.getMachineefficencykgcardpersixhours(),style);
            createCell(row,countRow++,carding.getMachineefficencykgcardperday(),style);
            createCell(row,countRow++,carding.getShift_a_sixHoursOne(),style);
            createCell(row,countRow++,carding.getAvervg_difference_a_sixHoursOne(),style);
            createCell(row,countRow++,carding.getShift_a_sixHoursTwo(),style);
            createCell(row,countRow++,carding.getAvervg_difference_a_sixHoursTwo(),style);
            createCell(row,countRow++,carding.getTotal_shift_prod_a(),style);
            createCell(row,countRow++,carding.getShift_b_sixHoursOne(),style);
            createCell(row,countRow++,carding.getAvervg_difference_b_sixHoursOne(),style);
            createCell(row,countRow++,carding.getShift_b_sixHoursTwo(),style);
            createCell(row,countRow++,carding.getAvervg_difference_b_sixHoursTwo(),style);
            createCell(row,countRow++,carding.getTotal_shift_prod_b(),style);
            createCell(row,countRow++,carding.getActual_producation(),style);
            createCell(row,countRow++,carding.getEfficiency(),style);
            createCell(row,countRow++,carding.getTarget_prod_variance_kg(),style);
            createCell(row,countRow++,carding.getTarget_prod_variance(),style);
